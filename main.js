console.time('Time taken to run script');
import * as fs from "fs"
import * as path from "path"
// import * as data from './main_files/Shuma47_node.js'; // TODO figure out how to make this dynamic
import {Knockdown_State_Static, Prox_Block_Static, namesTable_Static, floatingPointAddresses, MinMaxList} from "./main_files/staticData.js" // eval(testPath);
import * as data from "./main_files/Shuma47_node.js"
// import * as data from "./main_files/CaptainCommandoRogueCable8_node.js";

const NODE_JS_FILE = path.join(process.cwd(), "/main_files/Shuma47_node.js") // Current-Active-Working-File
...
// NG: This function is not used anymore
// //Write-Min/Max-Files
// for (let AllCharacterFloatValue in AllCharacterFloatingPointAddresses)
// {
...
//     }
//     if (!fs.existsSync(`${ DIR_OUTPATH }/${ AllCharacterFloatingPointAddresses[AllCharacterFloatValue] }_Min.js`))
//     {
//       fs.writeFileSync(`${ DIR_OUTPATH }/${ AllCharacterFloatingPointAddresses[AllCharacterFloatValue] }_Min.js`, `export var ${ AllCharacterFloatingPointAddresses[AllCharacterFloatValue] }_Max = `, 'utf8');
//     }
//     if (!fs.existsSync(`${ DIR_OUTPATH }/${ AllCharacterFloatingPointAddresses[AllCharacterFloatValue] }_Max.js`))
//     {
//       fs.writeFileSync(`${ DIR_OUTPATH }/${ AllCharacterFloatingPointAddresses[AllCharacterFloatValue] }_Max.js`, `export var ${ AllCharacterFloatingPointAddresses[AllCharacterFloatValue] }_Max = `, 'utf8');
//     }
...
// console.timeEnd('Time taken to run script');

function writeMinMaxToNodeJSFile()
{
  for (var MinMaxAddress in MinMaxList)
  {
    var tempAddress = eval(`data.${ MinMaxList[MinMaxAddress] }.split(',')`);
...
// console.log(typeof CLIP_LENGTH)




// let giveMelength = (`${prePend} "${ tempString }"; `);

// console.log(tempString.split(",").length)
