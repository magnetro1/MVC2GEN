...
-- label creations
`
let form3 = `--value assignments
`
let form4 = `-- timer creation
...
control_setPosition(label${loop8}, 10,${yOffset + yNumList0[i]})
...
control_setPosition(label${loop9}, ${10+xOffset},${yOffset + yNumList0[i]})
...
control_setPosition(label${loop10}, ${10+xOffset*2},${yOffset +yNumList0[i]})
...
control_setPosition(label${loop11}, ${10+xOffset*3},${yOffset + yNumList0[i]})
...
console.log(form1 + text1 + text2 + form3 + text3 + form4 + text4 + form5 + text5 + `
--third column
` + text6 + `
-- fourth column
` + text7 + `
-- return/fifth row
` + text8 + `
-- row 2 column 2 / sixth row
` + text9 + `
-- row 2 column 3 / seventh row
` + text10 + `
-- row 2 column 4 / eigth row
` + text11 + form6 + text13 + form7)